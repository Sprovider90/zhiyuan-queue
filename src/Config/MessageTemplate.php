...
$config=[
    ...
    "1003"=>["name"=>"触发了预警条件","template"=>"【{pro_name}-{dev_no}-{target_values}】超标，请检查现场情况。","url"=>"ActId=1&dev_no={dev_no}&warnig_id={warnig_id}&project_id={project_id}&monitor_id={monitor_id}","type"=>2,"requestCheck"=>["warnig_id","dev_no","target_values"],"templateContentCheck"=>["pro_name"]],
