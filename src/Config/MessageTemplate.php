...
$config=[
    ...
    "1006"=>["name"=>"设备电量低于20%","template"=>"【{pro_name}-{areas_name}-{prosition_name}】设备电量低，请及时查看。","url"=>"ActId=0","type"=>1,"check"=>["pro_name","areas_name","prosition_name"]],
    "1007"=>["name"=>"设备电量低于10%","template"=>"【{pro_name}-{areas_name}-{prosition_name}】设备电量过低，请及时查看。","url"=>"ActId=0","type"=>1,"check"=>["pro_name","areas_name","prosition_name"]],
